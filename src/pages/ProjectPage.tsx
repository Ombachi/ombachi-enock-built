...
> = {
  "litu-vault": {
    ...
    outcome:
      "A modern hospital management system that unifies clinical, laboratory, and administrative workflows in one secure platform.",
    longDescription:
    ...
    metrics: [
      "EMR, lab, billing & pharmacy modules",
  ...
  "litu-hub": {
    ...
    problem:
      "Education is changing rapidly. Learning is no longer confined to the classroom. Students need the ability to learn independently, navigate digital information, develop practical skills, and prepare for a changing world of work. Many learning environments remain dependent on physical classrooms, fragmented learning materials, paper-based assessments, and limited visibility into individual student progress.",
    role: "Learning Architect — curriculum strategy, platform design, and instructor partnerships.",
    tools:
      "Learning management and course delivery, Digital course content and multimedia, Assignments, quizzes and question banks, Discussions and collaborative learning, Gradebook and competency tracking,Tutor feedback and assessment workflows.",
    outcome:
      "Litu Hub is being developed as a scalable digital learning ecosystem that can help institutions move progressively from: Classroom learning → Blended learning → Self-directed learning → Distance learning without requiring them to abandon the people, curriculum, culture, or physical infrastructure that already make their educational communities valuable.",
    longDescription:
    ...
    metrics: [
      ...
      "Courses, assessments & competency tracking",
      "Mobile-first digital learning environment",
    ],
  },
  "litu-diagnostics": {
    ...
    problem:
      "Many communities lack access to reliable, accredited diagnostic services, leading to delayed diagnoses and poor health outcomes.",
    ...
    outcome:
      "Building a scalable model for decentralised diagnostics that brings lab services closer to the people who need them.",
    longDescription:
    ...
    metrics: [
      "Targeting 10+ underserved communities",
      "ISO 15189 quality framework",
      "Partnerships with 3+ county health departments",
    ],
  },
  ecoswarm: {
    title: "EcoSwarm",
    ...
    problem:
      "Climate information is everywhere, but knowing about climate change does not automatically lead to action. At the same time, consumers increasingly want sustainable products but may struggle to identify credible options or understand their environmental value.",
  ...
  "mount-kenya-university": {
    ...
    problem:
      "University laboratory infrastructure and training programmes needed modernisation to meet evolving industry standards.",
    ...
    outcome:
      "Upgraded lab operations, improved student competency outcomes, and stronger alignment with professional standards.",
    longDescription:
    ...
    metrics: [
      ...
      "Modernised SOPs across 4 departments",
  ...
  "nairobi-womens-hospital": {
    ...
    outcome:
      "Consistently reliable results, reduced turnaround times, and a culture of mentorship that strengthened the entire team.",
    longDescription:
    ...
    <PageTransition>
      <div className="min-h-screen bg-background">
        ...
        <section className="pt-28 pb-16 bg-primary">
          <div className="section-container">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <h1 className="text-3xl md:text-5xl font-serif font-bold text-primary-foreground">{project.title}</h1>
            </div>
            {project.link && (
              <a
                href={project.link}
        ...
        <section className="section-padding">
          <div className="section-container">
            <p className="text-muted-foreground leading-relaxed text-lg mb-8 max-w-3xl">{project.longDescription}</p>
            ...
            <div className="flex flex-wrap gap-4 mb-12">
              {project.metrics.map((m) => (
                <div
                  key={m}
                  className="flex items-center gap-2 bg-secondary/10 text-secondary px-4 py-2 rounded-full text-sm font-medium"
                >
                  <TrendingUp size={14} />
                  {m}
                </div>
